...
def analyze_market(symbol, rows):
    ...
    # Therefore only closed candles are used.
    closed = candles[:-1]
    ...
    # Calculated levels only.
    # They are NOT submitted to Tabdeal yet.
    sl = entry * 0.995
    tp = entry * 1.010
...
def place_real_futures_order(
    ...
    # Verified official SDK pattern:
    # Future.new_order(...)
    #
    # IMPORTANT:
    # LEVERAGE is NOT passed here because the verified
    # tabdeal-python example does not expose a leverage
